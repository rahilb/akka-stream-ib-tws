...
class IBEventWrapper extends EWrapper {
  import Events._

  val buffer = new ConcurrentLinkedQueue[IBEvent]()
  val f: IBEvent => Boolean = buffer.offer
  ...
  override def tickPrice(i: Int, i1: Int, v: Double, i2: Int): Unit =
    f(TickPrice(i, i1, v, i2))
